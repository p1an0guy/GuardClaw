...
import { acknowledgeAction, chatWithGuardClaw, createSavedLocation, getActiveIncident, getAuditLog, getEmergencyContacts, getHousehold, getLatestIncident, getSavedLocations, getTimeline } from "@/lib/api";
import type {
...
export default function DashboardPage() {
  ...
  async function handleChatSend(e: React.FormEvent) {
    ...
    setChatSending(true);
    try {
      const reply = await chatWithGuardClaw(msg, updated.slice(0, -1));
